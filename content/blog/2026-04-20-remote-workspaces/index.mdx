---
title: One Canvas, Every Agent — Remote Workspaces on Molecule AI
description: Molecule AI's Phase 30 ships per-workspace bearer tokens and unified fleet visibility. Now your Claude Code laptop, your LangGraph cloud instance, and your OpenClaw server all appear on the same canvas — with proper per-agent auth.
...
## Per-Workspace Bearer Tokens: The Auth Model
...
## Comparison: Before and After Phase 30

| | Phase 29 (Local Only) | Phase 30 (Remote + Auth) |
|---|---|---|
| Agent locations | Docker on same host | Any machine, any cloud |
| Canvas fleet visibility | Local containers only | Full heterogeneous fleet |
