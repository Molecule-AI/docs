---
title: Organization API Keys Architecture
description: Technical deep-dive on org-scoped bearer token authentication — token properties, auth tiers, audit trail, and DB schema.
---

# Organization API Keys

> **Status:** Shipped (beta), 2026-04-20. See [`docs/guides/org-api-keys.md`](/docs/guides/org-api-keys) for user-facing usage.
