...
> **Note:** Yesterday's (2026-05-16) changelog entry covers Hermes workspace MCP server wiring, bearer-token 401 fixes, Claude Code template Kimi K2.6 routing, and the platform-side token-injection ownership fix — see the [2026-05-16 section](#2026-05-16) below.
